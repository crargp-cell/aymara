...
export function AndeanBackground() {
  return (
    <div className="fixed inset-0 -z-10 w-full h-full pointer-events-none overflow-hidden" aria-hidden="true">
      ...
      <div className="absolute -bottom-32 left-[25%] w-96 h-96 bg-andino-oro/20 rounded-full blur-[100px]" />
      <div className="absolute top-[20%] left-[40%] w-64 h-64 bg-andino-azul/10 rounded-full blur-[90px]" />

      {/* 1. Chakana — superior izquierda */}
      <div className="absolute top-[8%] left-[5%] w-32 h-32 opacity-50 rotate-12 animate-float">
      ...
      <div className="absolute bottom-[12%] right-[8%] w-48 h-48 opacity-60 -rotate-6 animate-float-reverse">
      ...
      <div className="absolute top-[40%] right-[12%] w-28 h-28 opacity-55 rotate-12 animate-float">
      ...
      <div className="absolute top-[10%] right-[20%] w-32 h-32 opacity-45 animate-spin-slow">
      ...
      <div className="absolute top-[30%] left-[-8%] w-72 h-36 opacity-35 -rotate-6 animate-float-reverse">
      ...
      <div className="absolute bottom-[8%] left-[12%] w-44 h-44 opacity-50 rotate-6 animate-float">
        <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-lg" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="absolute bottom-[15%] left-[45%] w-20 h-20 opacity-60 -rotate-12 animate-float-fast">
      ...
      <div className="absolute top-[65%] left-[30%] w-28 h-16 opacity-45 rotate-12 animate-float">
      ...
      <div className="absolute top-[45%] left-[15%] w-5 h-5 bg-andino-oro rotate-45 animate-spin-slow opacity-80" />
      <div className="absolute top-[25%] right-[45%] w-6 h-6 border-4 border-andino-terracota rotate-45 opacity-60 animate-float-fast" />
      <div className="absolute bottom-[25%] right-[30%] w-4 h-4 bg-andino-verde rotate-12 animate-spin-slow-reverse opacity-70" />
      <div className="absolute bottom-[40%] left-[35%] w-10 h-10 border-[6px] border-andino-morado rotate-45 opacity-40 animate-float-reverse" />

      {/* Escaleras sueltas (chakana parcial) */}
      <div className="absolute top-[60%] right-[38%] opacity-50 animate-float-reverse rotate-6">
      ...
      <div className="absolute top-[15%] left-[35%] opacity-40 animate-float">
