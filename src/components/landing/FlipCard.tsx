...
export function FlipCard({ image, title, description }: { image: string; title: string; description: string }) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="panel absolute inset-0 rounded-2xl p-4 flex flex-col items-center justify-center gap-2 [backface-visibility:hidden]">
        ...
        <div
          className="panel-strong absolute inset-0 rounded-2xl p-4 flex items-center justify-center text-center [backface-visibility:hidden]"
